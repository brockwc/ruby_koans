...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject combines elements of an enumerable together by applying some logic specified in a block to each number.
    # In the first example 0 is added to each number and the sum of all three is returned.
    # in the second example each item is multiplied by one and then multiplied together.
  end
